...
<div class="form-widget">
	...
	>
		...
		<div>
			...
			<input id="firstName" name="firstName" type="text" value={form?.firstName ?? firstName ?? ""} required/>
		</div>

		<div>
			<label for="lastName">Apellidos</label>
			<input id="lastName" name="lastName" type="text" value={form?.lastName ?? lastName ?? ""} required/>
		</div>

		<div>
			<label for="phoneNumber">Número de teléfono celular</label>
			<input id="phoneNumber" name="phoneNumber" type="tel" value={form?.phoneNumber ?? phoneNumber ?? ""} required/>
		</div>
		...
		<div>
			...
			<label for="idNumber">Número de identificación:</label>
  			<input type="text" id="idNumber" name="idNumber" value={form?.idNumber ?? idNumber ?? ""} required>
		</div>
